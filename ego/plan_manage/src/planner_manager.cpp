...
namespace ego_planner
{
                                         ...
                                         const Eigen::Vector3d &end_pos, const Eigen::Vector3d &end_vel, const Eigen::Vector3d &end_acc)
  {
    ...
    // generate global reference trajectory
    // cout << "success455=" <<endl;
    vector<Eigen::Vector3d> points;
    points.push_back(start_pos);
    points.push_back(end_pos);
    // cout << "points[0][0]=" <<points[0][0]<<endl;
    // cout << "points[0][1]=" <<points[0][1]<<endl;
    // cout << "points[0][2]=" <<points[0][2]<<endl;
    // cout << "points[1][0]=" <<points[1][0]<<endl;
    // cout << "points[1][1]=" <<points[1][1]<<endl;
    // cout << "points[1][2]=" <<points[1][2]<<endl;
    ...
    // write position matrix
    int pt_num = inter_points.size();
    // cout << "inter_points.size()=" <<inter_points.size()<<endl;
    Eigen::MatrixXd pos(3, pt_num);
    for (int i = 0; i < pt_num; ++i)
      pos.col(i) = inter_points[i];
    ...
    time(0) *= 2.0;
    time(time.rows() - 1) *= 2.0;
    // cout << "success505=" <<endl;

    PolynomialTraj gl_traj;
    // cout << "success508=" <<endl;
    if (pos.cols() >= 3){
      // cout << "success510=" <<endl;
      gl_traj = PolynomialTraj::minSnapTraj(pos, start_vel, end_vel, start_acc, end_acc, time);
      cout << "success512=" <<endl;
    }
    else if (pos.cols() == 2){
      cout << "success515=" <<endl;
      gl_traj = PolynomialTraj::one_segment_traj_gen(start_pos, start_vel, start_acc, end_pos, end_vel, end_acc, time(0));
      
    }
    else{
      cout << "success518=" <<endl;
      return false;
    }
      
    cout << "success521=" <<endl;
    auto time_now = ros::Time::now();
    global_data_.setGlobalTraj(gl_traj, time_now);
   cout << "success516=" <<endl;
    return true;
  }
