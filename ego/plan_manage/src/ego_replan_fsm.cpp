...
namespace ego_planner
{
  ...
  void EGOReplanFSM::init(ros::NodeHandle &nh)
  {
    ...
    cout << "target_type_=" << target_type_<<endl; //target_type_ 测试结果为1
    ...
    cout << "waypoint_num_=" << waypoint_num_<<endl; //target_type_ 测试结果为1
    ...
    else if (target_type_ == TARGET_TYPE::PRESET_TARGET)
    {
      ...
      {
        // cout << "what what whatzp =" << waypoint_num_<<endl;
        ros::spinOnce();
        ros::Duration(0.001).sleep();
      }
      cout << "what what what =" << waypoint_num_<<endl;
      readGivenWps();
    }
    else
  ...
  void EGOReplanFSM::readGivenWps()
  {
    ...
    // cout << "what 114=" << waypoint_num_<<endl;
    // cout << "waypoint_num_ 114=" << waypoint_num_<<endl;
    // cout << "waypoints_[0][0];=" << waypoints_[0][0]<<endl;
    // cout << "waypoints_[0][1];=" << waypoints_[0][1]<<endl;
    // cout << "waypoints_[0][2];=" << waypoints_[0][2]<<endl;
    ...
    // cout << "what 129=" << waypoint_num_<<endl;
    // plan first global waypoint
    wp_id_ = 0;
    planNextWaypoint(wps_[wp_id_]);
    // cout << "what 133=" << waypoint_num_<<endl;
  ...
  void EGOReplanFSM::execFSMCallback(const ros::TimerEvent &e)
  {
    ...
    if (fsm_num == 100)
    {
      ...
      if (!have_odom_)
        cout << "no odom." << endl;
      if (!have_target_)
        cout << "wait for goal or triggerzp0504." << endl;
      fsm_num = 0;
    }
